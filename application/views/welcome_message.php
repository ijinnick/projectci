<body data-spy="scroll" data-offset="0" data-target="#navbar-main">
      ...
      <div class="container">
		...
		<div class="container" id="services" name="services">
			...
			<div class="row">
				...
				<br>
				<div class="col-lg-offset-2 col-lg-8">
					<img class="img-responsive" src="<?php echo base_url('assets/shield/img/iphone.png') ?>" alt="">
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- container -->
		...
		<br>
			<div class="row white centered">
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<?php echo base_url('assets/shield/img/team/team01.jpg') ?>" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<?php echo base_url('assets/shield/img/team/team02.jpg') ?>" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<?php echo base_url('assets/shield/img/team/team03.jpg') ?>" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="<?php echo base_url('assets/shield/img/team/team04.jpg') ?>" height="120px" width="120px" alt="">
					<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 centered">
						<img class="img-responsive" src="<?php echo base_url('assets/shield/img/macbook.png') ?>" align="">
					</div>
					<div class="col-lg-4">
						<h2>We Are Hiring!</h2>
		...
		<br>
			...
			<div class="row">	
				...
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/img/portfolio/folio01.jpg') ?>" alt="">
							<figcaption>
								<h5>DASHBOARD</h5>
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <p><img class="img-responsive" src="<?php echo base_url('assets/shield/img/portfolio/folio01.jpg') ?>" alt=""></p>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/img/portfolio/folio02.jpg') ?>" alt="">
							<figcaption>
								<h5>UI DESIGN</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/img/portfolio/folio03.jpg') ?>" alt="">
							<figcaption>
								<h5>ANDROID PAGE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
			...
			<div class="row">	
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/shield/img/portfolio/folio04.jpg') ?>" alt="">
							<figcaption>
								<h5>PROFILE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/shield/img/portfolio/folio05.jpg') ?>" alt="">
							<figcaption>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="<?php echo base_url('assets/shield/shield/img/portfolio/folio06.jpg') ?>" alt="">
							<figcaption>
								<h5>PHONE MOCKUP</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
		...
		<br>
			...
			<div class="row">
				<div class="col-lg-6 blog-bg">
					...
					<br>
						<p><img class="img img-circle" src="<?php echo base_url('assets/shield/shield/img/team/team04.jpg') ?>" width="60px" height="60px"></p>
						<h4>Jaye Smith</h4>
				...
				<div class="col-lg-6 blog-bg">
					<div class="col-lg-4 centered">
					<br>
						<p><img class="img img-circle" src="<?php echo base_url('assets/shield/shield/img/team/team03.jpg') ?>" width="60px" height="60px"></p>
						<h4>Michele Lampa</h4>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/shield/shield/js/bootstrap.min.js') ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/shield/shield/js/retina.js') ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/shield/shield/js/jquery.easing.1.3.js') ?>"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/shield/shield/js/smoothscroll.js') ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/shield/shield/js/jquery-func.js') ?>"></script>
  </body>